export const vehicleResponseMock = {
...
export const filmsResponseMock = {
  count: 6,
  next: null,
  previous: null,
  results: [
...
export const starshipResponseMock = {
  name: 'CR90 corvette',
  model: 'CR90 corvette',
...
export const starshipsResponseMock = {
  count: 36,
...
export const planetResponseMock = {
  name: 'Alderaan',
  rotation_period: '24',
  orbital_period: '364',
  diameter: '12500',
...
export const planetsResponseMock = {
  count: 60,
...
export const speciesResponseMock = {
  name: 'Droid',
...
export const speciesManyResponseMock = {
  ...
  results: [
    ...
    },
    {
      ...
      language: 'Shyriiwook',
      people: ['https://swapi.dev/api/people/13/', 'https://swapi.dev/api/people/80/'],
      films: [
        'https://swapi.dev/api/films/1/',
        'https://swapi.dev/api/films/2/',
        'https://swapi.dev/api/films/3/',
...
export const personResponseMock = {
  name: 'Luke Skywalker',
  height: '172',
  mass: '77',
  hair_color: 'blond',
